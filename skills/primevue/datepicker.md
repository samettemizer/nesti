...
| selectionMode | any | single | Defines the quantity of the selection. |
| dateFormat | string | - | Format of the date. Defaults to PrimeVue Locale configuration. |
| updateModelType | any | date | Type of the value to write back to modelValue. |
...
| iconDisplay | any | 'button' | Icon position of the component. This only applies if the showIcon option is set to true. |
...
| view | any | date | Type of view to display. |
...
| hourFormat | any | 24 | Specifies hour format. |
